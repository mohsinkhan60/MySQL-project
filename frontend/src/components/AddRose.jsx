                    ...
                    >
                            <Form className='py-3'>
                                <div className="mb-3">
                                    ...
                                    <Field name="title" type="text" className="w-full py-2 outline-none border-b bg-primary rounded-md text-white px-3 placeholder:text-gray-300 border-b-white" placeholder='Enter Rose Title' />
                                    <ErrorMessage name='title' className='text-xs text-red-500 ' component={'p'} />
                                </div>
                                <div className="mb-3">
                                    <label htmlFor="image" className='text-white text-sm'>Image</label>
                                    <Field name="image" type="text" className="w-full py-2 outline-none border-b bg-primary rounded-md text-white px-3 placeholder:text-gray-300 border-b-white" placeholder='Enter Rose Image URL' />
